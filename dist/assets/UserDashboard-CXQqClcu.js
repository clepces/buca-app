import{S as i}from"./StatCard-DJ07MMaI.js";import{s as a,L as l}from"./index-D_o6p_Zt.js";import{g as d}from"./dashboard.service-Dg9AhmKQ.js";function b(t,e){const c=a.user?.name||"Usuario",o=a.settings.currencies.principal.symbol||"$",n=r=>`${o}${new Intl.NumberFormat("es-VE",{minimumFractionDigits:2,maximumFractionDigits:2}).format(r)}`,s=d(e.products);return t.innerHTML=`
